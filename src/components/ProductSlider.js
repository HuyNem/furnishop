            ...
            <div className="grid grid-cols-2 gap-x-5 md:grid-cols-3 lg:grid-cols-4 lg:gap-[30px]">
              {page.productList.map((product, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="border hover:border-accent rounded-[18px] w-full 
                                    max-w-[285px] h-full max-h-[292px] flex items-center 
                                    justify-center mb-[15px] relative transition"
                    >
                      <img src={image.type} alt="" />
                      <div className="absolute bottom-4 right-[22px] bg-gray-200 p-2 rounded-[50px] hover:bg-gray-300">
